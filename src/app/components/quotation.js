                        ...
                        <div className="flex max-w-full  lg:pt-16  sm:pt-24  lg:pt-32 ">
                            <div className="flex">
                                ...
                                <div className="mt-4 p-4 w-[440px]">
                                    <p className="text-xl italic text-justify p-3">The world is a book and those who do not travel read only one page.</p>
                                    <p className="text-xl italic text-end text-gray-600 p-2">- Augustine of Hippo</p>
                                </div>
                            </div>
                        </div>
                    </div>
